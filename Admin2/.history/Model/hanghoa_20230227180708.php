<?php
    class hanghoa{
        ...
        {      
            $db=new connect();      
            $query="update product_details set name='$name',price=$price,  img='$img', type=$type, category_id=$category_id, description='$description', soluongton=$soluongton,slug = '' where mahh=$id ";
            $db->exec($query);    
        }
