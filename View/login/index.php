        ...
        <div class="container-form">
            <form action="" method="post" class="form-account">
                ...
                <div class="group-btn">
                    ...
                    <a style="color: #eee;text-decoration: none;margin-left: 10px;background-color: rgba(91, 80, 80, 0.848)" href="index.php?action=forgetps" class="btn-account">Forget Password</a>
                </div>
