      ...
      <tr>
        ...
        <td>
          ...
          <select name="category_id" class="form-control" style="width:150px;">
                <option value="1" <?php if($category_id == 1) {}; ?>>1</option>
                <option value="2" <?php if($category_id == 2) {}; ?>>2</option>
                <option value="3" <?php if($category_id == 3) {}; ?>>3</option>
                <option value="4" <?php if($category_id == 4) {}; ?>>4</option>
