                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="index.php?action=khachhang">Khách hàng</a>
                                <a class="dropdown-item" href="index.php?action=hanghoa">Sản phẩm</a>
                                <a class="dropdown-item" href="index.php?action=hoadon">Hóa đơn</a>
                                <a class="dropdown-item" href="index.php?action=importFile">Import Sản Phẩm</a>
                            </div>
                        </li>
                        <!-- Thống kê -->
                        <li class="nav-item dropdown">
