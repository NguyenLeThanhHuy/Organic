            ...
            <div class="col l-7 header-nav-box">
                <div class="header-nav">
                    <ul class="items-big">
                        ...
                        <li class="nav-item tag-li ">
                            <a href="index.php?action=allsanpham&i=<?php echo $all?>" class="tag-a">
                                <span class="danhmuc-sanpham">Sản phẩm<i class="fa-solid fa-caret-down"></i></span>
                            </a>
                            <ul class="item-small">
                                <li class="tag-li"><a href="index.php?action=raucu&i=<?php echo $raucu ?>" class="tag-a">Rau củ</a></li>
                                <li class="tag-li"><a href="index.php?action=hoaqua&i=<?php echo $hoaqua ?>" class="tag-a">Hoa quả</a></li>
                                <!-- <li class="tag-li"><a href="index.php?action=haisan" class="tag-a">Hải sản</a></li> -->
                                <li class="tag-li"><a href="index.php?action=cacloaihat&i=<?php echo $cacloaihat ?>" class="tag-a">Các loại hạt</a></li>
                                <li class="tag-li"><a href="index.php?action=thucphamtuoisong&i=<?php echo $thucphamtuoisong ?>" class="tag-a">Thực phẩm tươi sống</a></li>
                            </ul>
                        </li>
                        <li class="nav-item tag-li ">
