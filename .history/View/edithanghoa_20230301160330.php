...
<div class="row col-md-4 col-md-offset-4" >
    ...
    <?php 
      ...
      if($ac == 2) {
        echo '<form action="index.php?action=hanghoa&act=thempsp_action" method="post" enctype="multipart/form-data">';
      }
    ?>
    <table class="table" style="border: 0px;">
      ...
      <tr>
        <td>Mã hàng</td>
        <td> <input type="text" <?php if($ac == 1) echo '' ?> disabled class="form-control" name="mahh" value="<?php if(isset($id)) echo $id; ?>"  readonly/></td>
      </tr>
      <tr>
        <td>Tên hàng</td>
        ...
        <td>
          ...
          <select name="category_id" class="form-control" style="width:150px;">
                ...
                if(isset($category_id)) {
                  ...
                  echo '<option value="1" '.(($category_id==1)?'selected="selected"':"").'>1</option>';
                  echo '<option value="2" '.(($category_id==2)?'selected="selected"':"").'>2</option>';
                  echo '<option value="3" '.(($category_id==3)?'selected="selected"':"").'>3</option>';
                  echo '<option value="4" '.(($category_id==4)?'selected="selected"':"").'>4</option>';
