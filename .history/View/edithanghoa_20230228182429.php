...
<div class="row col-md-4 col-md-offset-4" >
    ...
    <table class="table" style="border: 0px;">
      ...
      <tr>
        ...
        <td>
          <input type="text" class="form-control" value="<?php if(isset($type)) echo $id; ?>" name="nhom" >
        </td>
      </tr>
      <tr>
        <td>Mã loại</td>
      ...
      <tr>
        <td>Số lượng tồn</td>
        <td><input type="text" value="<?php if(isset($description)) echo $description; ?>" class="form-control" name="slt" >
        </td>
      </tr>
      <tr>
        <td>Màu sắc</td>
