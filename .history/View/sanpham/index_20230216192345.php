                ...
                <div class="chitiet-body">
                    <div class="chitiet-body-header">
                        <div class="row">
                            ...
                            <?php
                            $select= "select user.fullname, binhluan1.noidung from user , binhluan1 where user.fullname = binhluan1.namekh and namehh='".$set['name']."' ORDER by mabl DESC;";
                            $data = executeResult($select);
                            var_dump($select);
                            exit();
                            ?>
                                <div class="row">
                                    <img src="/assets/img/brand_1.png" width="50px" height="50px" alt="">
