            ...
            <div class="chitietsanpham">
                ...
                <div class="chitiet-body">
                    <div class="chitiet-body-header">
                        <div class="row">
                            <span class="chitiet-title-mota " data-title="#chitiet-mota">
                                Mô tả
                            </span>
                            ...
                            <span class="chitiet-title-mota " data-title="#chitiet-mota">
                            <form action="index.php?action=add_cmt&slug=<?php echo $set['slug']?>&name=<?php echo $set['name']?>" method="post">
                            <div class="row">
                                <textarea name="comment" type="text" id="" cols="30" rows="5"></textarea>
                                ...
                                if(isset($_GET['slug'])) {
                                    // $id = $_GET['slug'];
                                    $usr = new user();
                                    $result7 = $usr->Tongcomment($set['name']);
                                    
                                }
                                ?>
                                Đánh Giá (<?php echo $result7 ?>)
                            </span>
                            <?php
                            $user2 = new user();
                            $data5 = $user2->HienThicomment($set['name']);
                           
                            while($item = $data5 ->fetch()){
                            ?>
                                <div class="row">
                                    <img src="assets/img/bg_breadcrumb.png" width="50px" height="50px" alt="">
                                    <p><?php echo '<b>'.$item['fullname'].': </b>'.$item['noidung']; ?></p><br>
                                 </div>
                            <?php
                            }
                            ?>
