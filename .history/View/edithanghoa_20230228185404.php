      ...
      <tr>
        ...
        <!-- value="Admin" {{'Admin' == $edit->role ? 'selected' : ''}} -->
          <select name="maloai" class="form-control" style="width:150px;">
                ...
                <option value="2" <?php if($category_id == 1) echo 'selected'; ?>>2</option>
                <option value="3" <?php if($category_id == 1) echo 'selected'; ?>>3</option>
                <option value="4" <?php if($category_id == 1) echo 'selected'; ?>>4</option>
                <option value="5" <?php if($category_id == 1) echo 'selected'; ?>>5</option>
          </select>
        </td>
      </tr>
