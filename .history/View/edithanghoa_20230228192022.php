...
<div class="row col-md-4 col-md-offset-4" >
    ...
    <table class="table" style="border: 0px;">
      ...
      <tr>
        <td>Slug</td>
        <td><input type="text" class="form-control" name="name" value="<?php if(isset($slug)) echo $slug; ?>"  maxlength="100px"></td>
      </tr>
      <tr>
        <td>Đơn giá</td>
      ...
      <tr>
        ...
        <td>
            ...
            Chọn file để upload:
            <input type="file" name="image" value="<?php if(isset($img)) echo $img; ?>" id="fileupload">
      ...
      <tr>
        ...
        <!-- value="Admin" {{'Admin' == $edit->role ? 'selected' : ''}} -->
          <select name="catelogy_id" class="form-control" style="width:150px;">
                ...
                <!-- <option value="5" <?php if($category_id == 5) echo 'selected'; ?>>5</option> -->
          </select>
        </td>
      </tr>
