<?php
    ...
    if(!empty($_POST)) {
        ...
        if(isset($_SESSION['email'])) {
            ...
            if($data == null) {
                $sql = "INSERT INTO cart (user_name,product_id,price,num,soluong) VALUES ('$user_name',$product_id,'$price','$num')";
                execute($sql);
            }else {
            ...
            // Nêu sản phẩm không tồn tại thì thêm vào giỏ hàng
                ...
                $sql = "INSERT INTO cart (user_name,product_id,price,num,soluong) VALUES ('Client',$product_id,'$price','$num')";
                execute($sql);
