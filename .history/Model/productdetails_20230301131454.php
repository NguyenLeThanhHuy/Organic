<?php 
    class productdetails{
        ...
        {      
            $db=new connect();      
            $query="in product_details set name='$name',price='$price',  img='$img', type='$type', category_id=$category_id, description='$description', soluongton=$slt,slug = '$slug' where mahh=$id ";
